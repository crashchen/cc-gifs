...
- `spinner-words.md`: the full official catalog of 148 spinner words with Chinese translations and descriptions
...
The generator currently covers **148 official spinner words**. Most compact scenes render as 6-frame loops at 170ms per frame, while some handcrafted scenes use longer timelines.
